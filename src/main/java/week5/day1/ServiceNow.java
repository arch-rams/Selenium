...
public class ServiceNow {
	...
	public String enterIncidentDetails(WebDriver driver, String desc, String caller) {
	...
	/*
	 * 	public String searchInc(WebDriver driver, String incNum) {
		driver.switchTo().frame("gsft_main");

		Select searchCrit = new Select(driver.findElement(By.cssSelector(".form-control.default-focus-outline")));
		searchCrit.selectByValue("number");
		driver.findElement(By.xpath("(//div[@class='input-group']//input[@placeholder='Search'])[1]"))
				.sendKeys(incNum + Keys.ENTER);
